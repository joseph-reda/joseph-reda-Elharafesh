// src/components/InfiniteBookGrid.jsx ← النسخة النهائية المثالية
...
export default function InfiniteBookGrid({ filteredBooks = null }) {
    ...
    useEffect(() => {
        ...
        const loadBooks = async () => {
            ...
            // ترتيب ذكي: المتاحة أولًا، ثم المباعة، ثم الأحدث
    ...
    }, [filteredBooks]); // ← مهم جدًا: يتغير لما filteredBooks يتغير
        ...
        <>
            ...
            >
                {displayedBooks.map((book, index) => (
                    <motion.div
                        key={`${book.id}-${book.createdAt || index}`} ref={index === displayedBooks.length - 1 ? lastBookRef : null}
                        layout
