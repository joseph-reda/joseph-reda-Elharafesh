...
export default function ManageBooks() {
    ...
    const [formData, setFormData] = useState({
        ...
        status: "available",
        order: 3, // 👈 إضافة القيمة الافتراضية 3 (وسط)
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const bookData = {
                ...
                order: Number(formData.order) || 3, // 👈 تأكيد تحويل للرقم
                images: imageUrls,
                createdAt: editingBook ? editingBook.createdAt : Date.now(),
                updatedAt: Date.now(),
            };

            // إذا كان الكتاب مباعًا، نجعل order = 0 تلقائيًا
                            ...
                            >
                                ...
                                <form onSubmit={handleSubmit} className="space-y-8">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <input type="text" placeholder="عدد الصفحات" value={formData.HPaper} onChange={(e) => setFormData({ ...formData, HPaper: e.target.value })} className="px-6 py-4 border border-gray-300 rounded-2xl focus:border-indigo-500 focus:outline-none text-lg" />
                                        ...
                                        <div>
                                            ...
                                            >
                                                <option value="0">0 - أدنى ترتيب (مباع)</option>
                                                <option value="1">1 - منخفض</option>
                                                <option value="2">2 - متوسط منخفض</option>
                                                <option value="3">3 - متوسط (افتراضي)</option>
                                                <option value="4">4 - متوسط عالي</option>
                                                <option value="5">5 - أعلى ترتيب</option>
                                            </select>
                                            <p className="text-sm text-gray-500 mt-1">كلما كان الرقم أكبر، ظهر الكتاب أعلى</p>
                                        </div>
